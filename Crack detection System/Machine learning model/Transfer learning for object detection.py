#Using reference from roboflow

!pip install tensorflow_gpu==1.15

import tensorflow==2.0.0 as tf
...
!curl -L https://app.roboflow.com/ds/7oxZp9NCcZ?key=kvzB5zeHB8 > roboflow.zip; unzip roboflow.zip; rm roboflow.zip
...
test_record_fname = '/content/tensorflow-object-detection-faster-rcnn/data/valid/FaseVMX.tfrecord'
train_record_fname = '/content/tensorflow-object-detection-faster-rcnn/data/train/FaseVMX.tfrecord'
label_map_pbtxt_fname = '/content/tensorflow-object-detection-faster-rcnn/data/train/FaseVMX_label_map.pbtxt'
...
!git clone https://github.com/tensorflow/models/archive/v1.13.0.zip
